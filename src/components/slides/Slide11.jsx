...
const QA = [
  {
    ...
    a: "זה 1 ₪ על כרטיס אשראי — לתפעול מלא של שני מועדונים, טכנולוגיה, סבסוד, ושירות. חברות מועדונים מסורתיות גובות 400-600K הקמה בלבד, ואז עוד עשרות אלפים בחודש — בלי לסבסד כלום. אצלנו ה-350K מתאפסים מהכנסות תוך 6 חודשים.",
    color: "#60A5FA",
  },
  {
