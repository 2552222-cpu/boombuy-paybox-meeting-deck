  ...
  return (
    <div className="relative h-full w-full bg-gradient-to-br from-[#0B1930] to-[#0a101d] flex flex-col px-10 md:px-16 py-12 overflow-hidden text-white">
      <div className="flex flex-col items-center text-center">
        <span className="text-sm font-bold text-[#3B82F6] tracking-wide">המצב היום</span>
        <h1 className="mt-3 text-2xl md:text-4xl font-black leading-tight max-w-3xl">
          מודל הסבסוד המסורתי הגיע לקצה היכולת שלו
        </h1>
      </div>

      <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-12 mt-10">
        {/* 90% circle */}
