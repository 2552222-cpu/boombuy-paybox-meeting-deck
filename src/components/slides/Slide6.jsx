    ...
    <div className="relative h-full w-full bg-white flex flex-col px-10 md:px-16 py-10 overflow-hidden">
      <div className="flex-1 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <div className="flex-1 text-right max-w-md">
          <span className="text-sm font-bold text-[#2D7FF9]">חוויית המשתמש באפליקציה</span>
          <h1 className="mt-3 text-3xl md:text-4xl font-black leading-tight text-[#0a1638]">
            הטמעה טבעית בתוך ה-UX הקיים
          </h1>
          <p className="mt-5 text-base md:text-lg leading-relaxed text-[#4a4a4a]">
